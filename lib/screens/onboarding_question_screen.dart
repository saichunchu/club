...
class _OnboardingQuestionScreenState
  ...
  Widget build(BuildContext context) {
    ...
    final keyboardVisible =
        MediaQuery.of(context).viewInsets.bottom > 0; // 👈 Keyboard detection

    // Decide alignment based on states
    final bool shouldMoveUp =
        keyboardVisible || _isRecording || _isCapturingVideo;
                              ...
                              decoration: InputDecoration(
                                ...
                                border: OutlineInputBorder(
                                  ...
                                  borderSide: BorderSide(
                                    color:
                                        AppColors.border2.withOpacity(0.3),
                                  ),
                                ),
                            ...
                            if (_videoPath != null &&
                              ...
                              _buildVideoRecordedPreview(
                                ...
                                onDelete: () {
                                  ...
                                  ref
                                      .read(
                                          recordedVideoPathProvider.notifier)
                                      .state = null;
                                },
                              ),
